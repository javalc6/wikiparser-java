...
public final class Plural extends ParserFunction {

    public final static ParserFunction Instance = new Plural();
	...
	public String evaluate(WikiPage wp, ArrayList<String> parameters, Frame parent) {
        if (parameters.size() == 1) {
			...
			if (!tp.parseParameter( parameters.get(0), wp, parent).equals("1") && (parameters.size() > 2))
