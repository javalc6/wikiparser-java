...
public abstract class ParserFunction {
	...
	abstract public String evaluate(WikiPage wp, ArrayList<String> parameters, Frame parent);

	public String format_error(String error_msg) {//helper to format error message
		return "<strong class=\"error\">" + error_msg + "</strong>";
	}
