...
```
compile: javac -encoding UTF-8 -cp .;lib\luaj-jse-3.0.2q.jar wiki\WikiFi
nd.java
...
usage: java -cp .;lib\luaj-jse-3.0.2q.jar wiki.TestSuite [test number from 0 to 4] [template to test]
